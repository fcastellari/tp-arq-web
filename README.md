...
+ **Swagger:** https://app.swaggerhub.com/apis/fcastellari/mdw-catalog-api/1.0.0
...
+ `PATCH` Actualizar un dominio. `400` `404` `500`
...
+ `PATCH` Actualizar un owner. `400` `404` `500`
...
| **Params**
- servicename   
+ `PATCH` Dar de alta un nuevo servicio. `400` `404` `500`
...
+ `PATCH` Actualizar servicio `400` `404` `500`
